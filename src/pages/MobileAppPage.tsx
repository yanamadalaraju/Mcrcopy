...
/>
    ...
    {/* SEO Meta Tags */}
    <Helmet>
  <title>Mobile App Development - MCRT Software</title>
  <meta
    name="description"
    content="Custom mobile applications designed to enhance user experience, streamline business processes, and drive customer engagement with MCRT Software."
  />
  <meta name="keywords" content="mobile app development, iOS, Android, custom mobile apps, business applications" />
  <meta name="author" content="MCRT Software" />
  <meta property="og:title" content="Mobile App Development - MCRT Software" />
  <meta
    property="og:description"
    content="MCRT Software specializes in creating custom mobile applications that transform how businesses operate and engage with their customers."
  />
  <meta property="og:image" content="URL_TO_IMAGE" />
  <meta property="og:url" content="http://mcrindia.in/mobile-app" />
  <meta name="twitter:title" content="Mobile App Development - MCRT Software" />
  <meta
