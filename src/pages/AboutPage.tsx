...
import React from "react";
import { Helmet } from "react-helmet"; // Importing react-helmet for SEO meta tags
import Header from "@/components/Header";
import Footer from "@/components/Footer";
import CTASection from "@/components/CTASection";
...
/>
      ...
      <Helmet>
        <title>About MCRT Software | Custom Software Development Company</title>
        <meta name="description" content="Learn about MCRT Software, a leading software development company offering Tally ERP customization, mobile apps, and enterprise software solutions tailored to business needs." />
        <meta name="keywords" content="MCRT Software, software development company, custom software solutions, Tally ERP customization, enterprise software, mobile app development, business solutions, software consulting, digital transformation, software company India" />
        <meta property="og:title" content="About MCRT Software | Custom Software Development Company" />
        <meta property="og:description" content="Discover how MCRT Software helps businesses grow through tailored software solutions, ERP customization, and cutting-edge app development." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="http://mcrindia.in/about" />
<meta property="og:image" content="http://mcrindia.in/images/og-image.jpg" />
<link rel="canonical" href="http://mcrindia.in/about" />
